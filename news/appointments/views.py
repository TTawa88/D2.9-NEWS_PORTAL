...
class AppointmentView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        send_mail(
            ...
            from_email='Djangomailtest1@yandex.ru',  # здесь указываете почту, с которой будете отправлять (об этом попозже)
            recipient_list=['ttawa@mail.ru',]  # здесь список получателей. Например, секретарь, сам врач и т. д.
        )
